...
export const initDatabase = async (db) => {
  await db.execAsync(`
    ...
    INSERT OR IGNORE INTO produtos (nome, categoria, preco, descricao, estoque) VALUES
    ('VINHO CANTINHO DO VALE', 'VINHO BARATO', 10.00, 'VINHO BAIXA QUALIDADE', 30),
    ('DRAFT', 'VINHO BARATO', 15.00, 'VINHO CHOPP', 20),
    ('PÉRGOLA', 'VINHO BARATO', 25.00, 'VINHO BOM', 15);
  `);
};
